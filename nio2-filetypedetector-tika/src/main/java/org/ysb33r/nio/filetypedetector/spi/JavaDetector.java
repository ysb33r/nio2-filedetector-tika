...
/** A Java implementation of a NIO2 FileTypeDetector.
 *
 */
public class JavaDetector extends FileTypeDetector {

    public JavaDetector() throws TikaException, IOException {
        tika = new TikaConfig();
    }
    ...
    public String probeContentType(Path path) throws IOException {
        try {
            ...
            return tika.getDetector().detect(TikaInputStream.get(path),metadata).toString();
